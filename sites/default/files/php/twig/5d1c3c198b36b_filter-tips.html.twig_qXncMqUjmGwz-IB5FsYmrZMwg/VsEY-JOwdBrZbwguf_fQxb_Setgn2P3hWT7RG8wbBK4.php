...
$context["name"]))];
                    // line 36
                    echo "      <div";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["tip"], "attributes", []), "addClass", [0 => (isset($context["tip_classes"]) ? $context["tip_classes"] : null)], "method"), "html", null, true));
                    echo ">
      <h3>";
                    // line 37
...
(isset($context["long"]) ? $context["long"] : null)) ? (("filter-" . twig_replace_filter($this->getAttribute($context["item"], "id", []), ["/" => "-"]))) : (""))];
                        // line 48
                        echo "        <li";
                        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "attributes", []), "addClass", [0 => (isset($context["item_classes"]) ? $context["item_classes"] : null)], "method"), "html", null, true));
                        echo ">";
  ...
  ";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "/home3/websiete/public_html/inmobiliariagag18.com/gaginmobiliaria/core/themes/classy/templates/content-edit/filter-tips.html.twig");
    }
}
