...
(isset($context["format"]) ? $context["format"] : null), "id", []))];
  ...
  <h4 class=\"label\">";
        // line 27
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["format"]) ? $context["format"] : null), "label", []), "html", null, true));
        echo "</h4>
  ";
        // line 28
...
";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/content-edit/filter-guidelines.html.twig", "/home3/websiete/public_html/inmobiliariagag18.com/gaginmobiliaria/core/themes/classy/templates/content-edit/filter-guidelines.html.twig");
    }
}
