    ...
    <noscript>
      ...
      ";
        ...
        if ($this->getAttribute(($context["gallery_options"] ?? null), "gallerytitle", [], "any", true, true)) {
            ...
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["gallery_options"] ?? null), "gallerytitle", []), "html", null, true));
            echo "</h1>
      ";
        }
        // line 26
        ...
        if ($this->getAttribute(($context["gallery_options"] ?? null), "gallerydescription", [], "any", true, true)) {
            ...
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["gallery_options"] ?? null), "gallerydescription", []), "html", null, true));
            echo "</p>
      ";
        }
        // line 29
...
";
    ...
    {
        return new Twig_Source("", "modules/contrib/juicebox/templates/juicebox-embed-markup.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/gagyasociados/modules/contrib/juicebox/templates/juicebox-embed-markup.html.twig");
    }
}
