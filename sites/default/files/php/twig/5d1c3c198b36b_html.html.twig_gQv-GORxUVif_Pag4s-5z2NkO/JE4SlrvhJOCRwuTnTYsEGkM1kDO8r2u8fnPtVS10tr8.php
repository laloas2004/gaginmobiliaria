...
<html";
  ...
  <body";
        // line 42
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", [0 => (isset($context["body_classes"]) ? $context["body_classes"] : null)], "method"), "html", null, true));
        echo ">
    ";
        // line 47
...
";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/layout/html.html.twig", "/home3/websiete/public_html/inmobiliariagag18.com/gaginmobiliaria/core/themes/classy/templates/layout/html.html.twig");
    }
}
