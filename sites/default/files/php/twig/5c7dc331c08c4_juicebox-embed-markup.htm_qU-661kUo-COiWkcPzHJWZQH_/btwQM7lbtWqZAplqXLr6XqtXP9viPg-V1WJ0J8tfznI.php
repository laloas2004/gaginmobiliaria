    ...
    <noscript>
      ...
      ";
        ...
        if ($this->getAttribute((isset($context["gallery_options"]) ? $context["gallery_options"] : null), "gallerytitle", array(), "any", true, true)) {
            ...
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["gallery_options"]) ? $context["gallery_options"] : null), "gallerytitle", array()), "html", null, true));
            echo "</h1>
      ";
        }
        // line 26
        ...
        if ($this->getAttribute((isset($context["gallery_options"]) ? $context["gallery_options"] : null), "gallerydescription", array(), "any", true, true)) {
            ...
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["gallery_options"]) ? $context["gallery_options"] : null), "gallerydescription", array()), "html", null, true));
            echo "</p>
      ";
        }
        // line 29
