...
$context["theme_group"], "state", [])), 2 => "clearfix"];
            // line 40
            echo "    <div";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["theme_group"], "attributes", []), "addClass", [0 => (isset($context["theme_group_classes"]) ? $context["theme_group_classes"] : null)], "method"), "html", null, true));
            echo ">
...
$context["theme"], "is_admin", [])) ? ("theme-admin") : ("")), 2 => "theme-selector", 3 => "clearfix"];
                // line 51
                echo "        <div";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["theme"], "attributes", []), "addClass", [0 => (isset($context["theme_classes"]) ? $context["theme_classes"] : null)], "method"), "html", null, true));
                echo ">
          ";
                // line 52
...
";
    ...
    {
        return new Twig_Source("", "core/themes/stable/templates/admin/system-themes-page.html.twig", "/home3/websiete/public_html/inmobiliariagag18.com/gaginmobiliaria/core/themes/stable/templates/admin/system-themes-page.html.twig");
    }
}
