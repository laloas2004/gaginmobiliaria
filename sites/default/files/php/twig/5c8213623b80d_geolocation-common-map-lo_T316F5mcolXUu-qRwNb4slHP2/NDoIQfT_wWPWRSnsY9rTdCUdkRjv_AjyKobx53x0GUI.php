...
class __TwigTemplate_016c79fb743e8d93a1d8d09a802261721ebbbae30482c2e3319c417d94ca5cd2 extends Twig_Template
{
    ...
    data-lat=\"";
        // line 12
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["position"] ?? null), "lat", []), "html", null, true));
        echo "\"
    data-lng=\"";
        // line 13
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["position"] ?? null), "lng", []), "html", null, true));
        echo "\"
    typeof=\"Place\"
    ";
        // line 15
    ...
    {
        return new Twig_Source("", "modules/contrib/geolocation/templates/geolocation-common-map-location.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/gagyasociados/modules/contrib/geolocation/templates/geolocation-common-map-location.html.twig");
    }
}
