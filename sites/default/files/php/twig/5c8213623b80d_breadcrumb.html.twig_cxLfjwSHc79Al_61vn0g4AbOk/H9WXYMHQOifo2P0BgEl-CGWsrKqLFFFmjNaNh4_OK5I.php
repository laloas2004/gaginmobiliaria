...
";
    ...
    ";
        ...
        <span class=\"breadcrumb__item-separator fa ";
                // line 17
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["mt_setting"] ?? null), "breadcrumb_separator", []), "html", null, true));
                echo "\"></span>
        ";
                // line 18
...
";
    ...
    {
        return new Twig_Source("", "themes/corporate_lite/templates/breadcrumb.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/gagyasociados/themes/corporate_lite/templates/breadcrumb.html.twig");
    }
}
