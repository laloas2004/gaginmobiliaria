...
(isset($context["derivative_plugin_id"]) ? $context["derivative_plugin_id"] : null)))];
        // line 42
        $context["heading_id"] = ($this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "id", []) . \Drupal\Component\Utility\Html::getId("-menu"));
        // line 43
        ...
        echo "\"";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_without($this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", [0 => (isset($context["classes"]) ? $context["classes"] : null)], "method"), "role", "aria-labelledby"), "html", null, true));
        echo ">
  ";
        // line 45
        echo "  ";
  ...
  <h2";
        ...
        echo ">";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["configuration"]) ? $context["configuration"] : null), "label", []), "html", null, true));
        echo "</h2>
  ";
        // line 50
...
";
  ...
  ";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/block/block--system-menu-block.html.twig", "/home3/websiete/public_html/inmobiliariagag18.com/gaginmobiliaria/core/themes/classy/templates/block/block--system-menu-block.html.twig");
    }
}
